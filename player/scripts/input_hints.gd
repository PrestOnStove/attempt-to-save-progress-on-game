@icon( "res://player/sprites/ch_03_game_systems/icons/input_hints.svg" )
...
func get_controller_type( device_id : int ) -> void:
	...
	set_process_input( false ) #can be updated later to check for controller types more than just at the start of launch
	pass
