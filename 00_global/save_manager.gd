...
func create_new_game_save( slot : int ) -> void:
	...
	var new_game_scene : String = "uid://mfgmqer5207o"
...
func load_game( slot : int ) -> void:
	...
	var scene_path : String = save_data.get( "scene_path", "uid://mfgmqer5207o" )
...
func load_configuration() -> void:
	...
	AudioServer.set_bus_volume_linear( 2, config.get_value( "audio", "music", 0.3 ) )
