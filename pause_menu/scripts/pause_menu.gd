...
@onready var sfx_slider: HSlider = $System/VBoxContainer/HBoxContainer3/SFXSlider
@onready var ui_slider: HSlider = $System/VBoxContainer/HBoxContainer4/UISlider
#endregion
